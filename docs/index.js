...
(function (fabric) {
  ...
  var reIsNative$1 = RegExp('^' + funcToString$1$1.call(hasOwnProperty$c).replace(reRegExpChar$1, '\\$&').replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$');
  ...
  function assignValue$1(object, key, value) {
    ...
    if (!(hasOwnProperty$9$1.call(object, key) && eq$1(objValue, value)) || value === undefined && !(key in object)) {
  ...
  var isArguments$1 = baseIsArguments$1(function () {
    ...
    return isObjectLike$1(value) && hasOwnProperty$8$1.call(value, 'callee') && !propertyIsEnumerable$1$1.call(value, 'callee');
  };
  ...
  function arrayLikeKeys$1(value, inherited) {
    ...
    for (var key in value) {
      if ((inherited || hasOwnProperty$7$1.call(value, key)) && !(skipIndexes && (
  ...
  var defaults$1 = baseRest$1(function (object, sources) {
    ...
    while (++index < length) {
      ...
      while (++propsIndex < propsLength) {
        ...
        if (value === undefined || eq$1(value, objectProto$3$1[key]) && !hasOwnProperty$3$1.call(object, key)) {
  ...
  ***************************************************************************** */
    ...
    for (var i = path.length - 1; i >= 0; i--) {
      ...
      if (i === path.length - 1) {
        if (instruction[0] === InstructionType$1.CLOSE) {
          ...
          _path.push([InstructionType$1.START].concat(_toConsumableArray(instruction.slice(instruction.length - 2))));
        }
      }
      switch (instruction[0]) {
        ...
        case InstructionType$1.QUADRATIC_CURCE:
          _path.push([InstructionType$1.QUADRATIC_CURCE, instruction[1], instruction[2]].concat(_toConsumableArray(preMajorPointCrood)));
          break;
        case InstructionType$1.BEZIER_CURVE:
          _path.push([InstructionType$1.BEZIER_CURVE, instruction[3], instruction[4], instruction[1], instruction[2]].concat(_toConsumableArray(preMajorPointCrood)));
          break;
  ...
  function isSymbol$1(value) {
    return _typeof(value) == 'symbol' || isObjectLike$1(value) && baseGetTag$1(value) == symbolTag$1$1;
  }
  ...
  var VizPath$1 = /*#__PURE__*/function () {
    ...
    return _createClass(VizPath, [{
      ...
      value: function getNeighboringControllers(pathwayNode) {
        ...
        if (pre) controllers.push({
          position: 'pre',
          direction: 'next',
          from: pre
        });
        if (next) controllers.push({
          position: 'next',
          direction: 'pre',
          from: next
        });
      ...
      value: function draw(pathway) {
        ...
        pathway.forEach(function (item) {
          ...
          section.forEach(function (pathwayNode, index) {
            ...
            var isStartSyncPoint = section[index + 1] && ((_a = section[index + 1].instruction) === null || _a === void 0 ? void 0 : _a[0]) === InstructionType$1.CLOSE;
            // 路径节点
            var node = VizPath.getInstructionNodeCrood(instruction);
            if (node && !pathwayNode.node) {
              if (isStartSyncPoint) {
                (_b = section[0].node) === null || _b === void 0 ? void 0 : _b.observe(function (x, y) {
            ...
            if (isStartSyncPoint) {
              if ((pathwayNode === null || pathwayNode === void 0 ? void 0 : pathwayNode.instruction[0]) === InstructionType$1.BEZIER_CURVE) {
                ...
                section[0].controllers = (_c = section[0].controllers) !== null && _c !== void 0 ? _c : {};
              ...
              if ((pathwayNode === null || pathwayNode === void 0 ? void 0 : pathwayNode.instruction[0]) === InstructionType$1.QUADRATIC_CURCE && pre && pre.instruction[0]) {
                ...
                section[0].controllers = (_d = section[0].controllers) !== null && _d !== void 0 ? _d : {};
    ...
    return _createClass(VizPathContext, [{
      ...
      value: function parsePathFromObject(path) {
        ...
        var pathway = sections.map(function (_ref11) {
          ...
          // ④ 小于两个点的闭合路径直接解除闭合
          if (section.length <= 2 && section[section.length - 1][0] === InstructionType$1.CLOSE) {
            section.pop();
          }
  ...
  var Editor$1 = /*#__PURE__*/function (_EditorModule) {
    ...
    return _createClass(Editor, [{
      ...
      key: "load",
      value: function () {
        var _load = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    ...
    return _createClass(EditorNode, [{
          ...
          (_a = _this15.vizPath) === null || _a === void 0 ? void 0 : _a.onceRerenderOriginPath(function () {
            ...
            try {
              var _loop = function _loop() {
                ...
                var controllers = (_b = (_a = _this15.vizPath) === null || _a === void 0 ? void 0 : _a.getNeighboringControllers(pathwayNode)) !== null && _b !== void 0 ? _b : [];
                controllers === null || controllers === void 0 ? void 0 : controllers.forEach(function (_ref15) {
                  var position = _ref15.position,
                    direction = _ref15.direction,
                    from = _ref15.from;
                  var _a;
                  var crood = (_a = from.controllers) === null || _a === void 0 ? void 0 : _a[direction];
      ...
      value: function _addActivePointObserve(object) {
        ...
        observe$1(object, ['left', 'top'], function (_ref16) {
          ...
          var controllers = (_b = (_a = _this16.vizPath) === null || _a === void 0 ? void 0 : _a.getNeighboringControllers(pathwayNode)) !== null && _b !== void 0 ? _b : [];
          controllers === null || controllers === void 0 ? void 0 : controllers.forEach(function (_ref17) {
      ...
      value: function _addActivePointControllers(nodeObject) {
        ...
        neighboringControllers.forEach(function (_ref18) {
          ...
          var _a, _b, _c, _d, _e;
          var node = from.node;
          var controller = (_a = from.controllers) === null || _a === void 0 ? void 0 : _a[direction];
          ...
          var point = (_b = _this17._abandonedPool.points.pop()) !== null && _b !== void 0 ? _b : ((_c = ui === null || ui === void 0 ? void 0 : ui.options.controllerPoint) !== null && _c !== void 0 ? _c : EditorUI$1$1.noneUI.controllerPoint)(pointDecorator);
          ...
          var onAddedPoint = function onAddedPoint() {
            ...
            observe$1(point, ['left', 'top'], function (_ref19) {
              ...
              if (((_a = point.canvas) === null || _a === void 0 ? void 0 : _a.getActiveObject()) === point) {
                ...
                if (_this17.setting.forcePointSymmetric !== 'none') {
                  var symmetricController = _this17.controllers.find(function (i) {
                    ...
                    return i.pathwayNode === ((_a = neighboringControllers.find(function (i) {
                  ...
                  if (symmetricController) {
                    ...
                    var scale = _this17.setting.forcePointSymmetric === 'entire' ? 1 : d / new_d;
          ...
          var line = (_d = _this17._abandonedPool.lines.pop()) !== null && _d !== void 0 ? _d : ((_e = ui === null || ui === void 0 ? void 0 : ui.options.controllerLine) !== null && _e !== void 0 ? _e : EditorUI$1$1.noneUI.controllerLine)(lineDecorator);
        ...
        var baseIndex = canvas._objects.indexOf(editorPath.paths[0].originPath) + editorPath.paths.length;
      ...
      value: function _initSelectEvents() {
        ...
        this.editor.on('canvas', 'mouse:dblclick', function (e) {
          var _a;
          if (e.target) return;
          var editorPath = (_a = _this18.vizPath) === null || _a === void 0 ? void 0 : _a.context.find(EditorPath$1$1);
          if (!editorPath) return;
          var focusPath;
      ...
      value: function _initConvertEvents() {
        ...
        this.editor.on('canvas', 'mouse:down:before', function (event) {
          ...
          if (((_a = event.target) === null || _a === void 0 ? void 0 : _a[VizPath$1.symbol]) !== VizPathSymbalType$1.NODE) return;
          ...
          if (activeObject && object !== activeObject) {
            ...
            if (_this21.controllers.filter(function (i) {
        ...
        this.editor.on('canvas', 'mouse:move', function (event) {
          ...
          if (convertibleNodes.length > 1) {
            convertibleNodes.sort(function (a, b) {
              return calcCroodsAngle$1(position, targetNode.node, neighboringNodes[a[0]].node) - calcCroodsAngle$1(position, targetNode.node, neighboringNodes[b[0]].node);
            });
          }
          convertibleNodes.forEach(function (item, index) {
            ...
            (_a = _this21.vizPath) === null || _a === void 0 ? void 0 : _a.replace(item[1], newInstruction);
          });
      ...
      value: function _initAddEvents() {
        ...
        this.editor.on('canvas', 'mouse:down:before', function (event) {
          ...
          if (event.target) {
            if (_this22.activeNodes.length === 1 && event.target[VizPath$1.symbol] === VizPathSymbalType$1.NODE) {
        ...
        this.editor.on('canvas', 'mouse:move', function (event) {
          ...
          var controller = (_a = _this22.controllers.find(function (i) {
            return i.pathwayNode === currentNode && i.type === 'next';
          })) !== null && _a !== void 0 ? _a : _this22.controllers.find(function (i) {
      ...
      value: function degrade(object) {
        ...
        targets.forEach(function (_ref23) {
          ...
          var oldInstruction = pathwayNode.instruction;
          if ([InstructionType$1.START, InstructionType$1.LINE].includes(oldInstruction[0])) return;
          var newInstruction = _toConsumableArray(oldInstruction);
          if (lowest) {
            newInstruction[0] = InstructionType$1.LINE;
            newInstruction.splice(1, newInstruction.length - 3);
          } else {
            newInstruction[0] = _defineProperty(_defineProperty({}, InstructionType$1.QUADRATIC_CURCE, InstructionType$1.LINE), InstructionType$1.BEZIER_CURVE, InstructionType$1.QUADRATIC_CURCE)[newInstruction[0]];
            newInstruction.splice({
              pre: -4,
              next: 1
            }[direction], 2);
      ...
      value: function add(position) {
        ...
        if (this.activeNodes.length === 1) {
          ...
          var pathway = VizPathContext$1.parsePathFromObject(new fabric.fabric.Path('M 0 0', position));
      ...
      value: function link(source, target) {
        ...
        targetPath.map(function (item) {
          ...
          for (var _i3 = 0; _i3 < instruction.length - 1; _i3 += 2) {
            var position = editorPath.calcAbsolutePosition(new fabric.fabric.Point(instruction[_i3 + 1], instruction[_i3 + 2]), vizPath.getPathway(target.section).originPath);
            var crood = editorPath.calcRelativeCrood(position, vizPath.getPathway(source.section).originPath);
    ...
    return _createClass(EditorPath, [{
      ...
      value: function _initClearListener(vizPath) {
        ...
        vizPath.on("clearAll", function () {
          canvas.remove.apply(canvas, _toConsumableArray(_this29.paths.map(function (i) {
            return i.originPath;
          })));
      ...
      value: function load(vizpath) {
        ...
        (_a = editor.canvas) === null || _a === void 0 ? void 0 : _a.on('mouse:dblclick', function (event) {
          ...
          if (pre && next) {
            ...
            var splitCurves = _this33._splitInstruction(Bezier.quadraticFromPoints.apply(Bezier, _toConsumableArray(points)).points, points[1]);
            var neighboringInstructions = vizpath.getNeighboringInstructions(pathwayNode);
            vizpath.replace(pathwayNode.instruction[0] === InstructionType$1.START ? neighboringInstructions.pre : pathwayNode, splitCurves.pre);
  ...
  ***************************************************************************** */
      ...
      value: function draw(pathway) {
        ...
        pathway.forEach(function (item) {
          ...
          section.forEach(function (pathwayNode, index) {
            ...
            var instruction = pathwayNode.instruction;
            // 是否是起始点的闭合重叠点，其路径节点沿用起始点，而曲线变换点也会被起始点占用
            var isStartSyncPoint = section[index + 1] && ((_a = section[index + 1].instruction) === null || _a === void 0 ? void 0 : _a[0]) === InstructionType.CLOSE;
            // 路径节点
            var node = VizPath.getInstructionNodeCrood(instruction);
            if (node && !pathwayNode.node) {
              if (isStartSyncPoint) {
  ...
  var VizPathContext = /*#__PURE__*/function () {
    ...
    return _createClass(VizPathContext, [{
      ...
      key: "parsePathFromURL",
      value: (function () {
        var _parsePathFromURL = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(url) {
          var options,
            object,
            pathGroup,
            pathways,
  ...
  var EditorPath = /*#__PURE__*/function (_EditorModule) {
    ...
    return _createClass(EditorPath, [{
      ...
      value: function _initClearListener(vizPath) {
        ...
        vizPath.on("clear", handler);
        vizPath.on("clearAll", function () {
          canvas.remove.apply(canvas, _toConsumableArray(_this3.paths.map(function (i) {
            return i.originPath;
          })));
    ...
    return _createClass(EditorNode, [{
      ...
      value: function _addActiveSelectionObserve(group) {
        ...
        observe(group, ['left', 'top', 'angle'], function () {
          var _a;
          (_a = _this3.vizPath) === null || _a === void 0 ? void 0 : _a.onceRerenderOriginPath(function () {
            var _a, _b;
            var hadFollowedCroods = new Set([]);
            ...
            try {
              var _loop = function _loop() {
                ...
                var controllers = (_b = (_a = _this3.vizPath) === null || _a === void 0 ? void 0 : _a.getNeighboringControllers(pathwayNode)) !== null && _b !== void 0 ? _b : [];
                controllers === null || controllers === void 0 ? void 0 : controllers.forEach(function (_ref3) {
      ...
      value: function _addActivePointObserve(object) {
        ...
        observe(object, ['left', 'top'], function (_ref4) {
          ...
          var controllers = (_b = (_a = _this4.vizPath) === null || _a === void 0 ? void 0 : _a.getNeighboringControllers(pathwayNode)) !== null && _b !== void 0 ? _b : [];
          controllers === null || controllers === void 0 ? void 0 : controllers.forEach(function (_ref5) {
      ...
      value: function _addActivePointControllers(nodeObject) {
        ...
        neighboringControllers.forEach(function (_ref6) {
          ...
          var point = (_b = _this5._abandonedPool.points.pop()) !== null && _b !== void 0 ? _b : ((_c = ui === null || ui === void 0 ? void 0 : ui.options.controllerPoint) !== null && _c !== void 0 ? _c : EditorUI.noneUI.controllerPoint)(pointDecorator);
          ...
          var onAddedPoint = function onAddedPoint() {
            ...
            observe(point, ['left', 'top'], function (_ref7) {
              var left = _ref7.left,
                top = _ref7.top;
              var _a;
              // 与中心点相对角度固定
          ...
          var line = (_d = _this5._abandonedPool.lines.pop()) !== null && _d !== void 0 ? _d : ((_e = ui === null || ui === void 0 ? void 0 : ui.options.controllerLine) !== null && _e !== void 0 ? _e : EditorUI.noneUI.controllerLine)(lineDecorator);
      ...
      value: function _initSelectEvents() {
        ...
        this.editor.on('canvas', 'mouse:dblclick', function (e) {
          var _a;
          if (e.target) return;
          var editorPath = (_a = _this6.vizPath) === null || _a === void 0 ? void 0 : _a.context.find(EditorPath);
          if (!editorPath) return;
          var focusPath;
          ...
          if (focusPath) {
            _this6.focus.apply(_this6, _toConsumableArray(_this6.nodes.filter(function (node) {
              return editorPath.nodePathMap.get(_this6.objectNodeMap.get(node).node) === focusPath;
            })));
          }
        });
      }
      ...
      value: function _initDrawEvents() {
        ...
        var updateNodes = function updateNodes() {
          ...
          canvas.requestRenderAll();
          // 保留原聚焦状态
          if (storeActiveObjects.length) _this7.focus.apply(_this7, _toConsumableArray(storeActiveObjects));
        };
        this.vizPath.on('draw', updateNodes);
      }
      /**
      ...
      value: function _initConvertEvents() {
        ...
        this.editor.on('canvas', 'mouse:down:before', function (event) {
          ...
          if (((_a = event.target) === null || _a === void 0 ? void 0 : _a[VizPath.symbol]) !== VizPathSymbalType.NODE) return;
          ...
          if (activeObject && object !== activeObject) {
            ...
            if (_this9.controllers.filter(function (i) {
              return i.node === object;
            }).length === 0) {
              var upgradeDirection;
              if (currentNode === pre) upgradeDirection = 'next';
        ...
        this.editor.on('canvas', 'mouse:move', function (event) {
          ...
          convertibleNodes.forEach(function (item, index) {
            ...
            newInstruction.splice(item[0] === 'pre' ? -2 : 1, 0, newCrood.x, newCrood.y);
            (_a = _this9.vizPath) === null || _a === void 0 ? void 0 : _a.replace(item[1], newInstruction);
          });
      ...
      value: function add(position) {
        ...
        if (this.activeNodes.length === 1) {
          ...
          var pathway = VizPathContext.parsePathFromObject(new fabric.fabric.Path('M 0 0', position));
          var responsivePathway = vizPath.draw(pathway);
          return this.nodeObjectMap.get(responsivePathway[0].section[0]);
        }
      }
      ...
      value: function link(source, target) {
        ...
        targetPath.map(function (item) {
          var instruction = item;
          for (var i = 0; i < instruction.length - 1; i += 2) {
            var position = editorPath.calcAbsolutePosition(new fabric.fabric.Point(instruction[i + 1], instruction[i + 2]), vizPath.getPathway(target.section).originPath);
            var crood = editorPath.calcRelativeCrood(position, vizPath.getPathway(source.section).originPath);
